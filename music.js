let munow = document.querySelector('.munow');
...
const music_list = [
    {
        img : 'muimage/chase.jpg',
        name : 'Cornfield Chase',
        artist : 'Hans Zimmer',
        music : 'music/Cornfield Chase.mp3'
    },
    {
        img : 'muimage/gatts.png',
        name : 'gatts',
        artist : '平沢進',
        music : 'music/gatts.mp3'
    },
    {
        img : 'muimage/melody.jpg',
        name : 'Melody(Original mix)',
        artist : 'Ash',
        music : 'music/Melody.mp3'
    },
    {
        img : 'muimage/umbrella.jpg',
        name : 'Umbrella(Matte Remix)',
        artist : 'Matte / Ember Island',
        music : 'music/Umbrella.mp3'
    }
]; 
...
function loadTrack(track_index){
    ...
    munow.textContent = "Playing music " + (track_index + 1) + " of " + music_list.length;
...
function setUpdate(){
    ...
    if(!isNaN(curr_track.duration)){
        ...
        totaltime.textContent = durationMinutes + ":" + durationMinutes;
    }
}
